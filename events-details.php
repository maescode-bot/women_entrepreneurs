...
<?php
	...
	$pid=intval($_GET['nid']);
	$query=mysqli_query($con,"select id, PostTitle, PostImage, PostDate, TIME_FORMAT(PostTime, '%h:%i %p') PostTime, PostDetails from tblevents where id='$pid'");
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 order-1 order-md-2 align-self-center">
                                <ul class="breadcrumb d-block text-md-right breadcrumb-light appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="400">
                                    ...
                                    <li class=""><a href="news.php">Event</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                                ...
                                <article>
                                    <div class="card border-0 border-radius-0 mb-5">
                                        <div class="card-body p-0 z-index-1">
                                            ...
                                            <p class="text-uppercase text-3 mb-3 text-color-default custom-font-secondary"><time>
		                        				<b>Time: </b> 
                        		                <?php 
                                                  $time= htmlentities($row['PostTime']);
                                                  echo $time;
                                                ?>
                                            </time>
                                            </p>
                                            <p class="text-uppercase text-3 mb-3 text-color-default custom-font-secondary">
                                                <b>Date: </b>
                                                <?php 
                            ...
                            <div class="col-lg-3 pt-4 pt-lg-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="900">
                                <aside class="sidebar">
                                    ...
                                    <div class="px-3 mt-4">
                                        <h3 class="text-color-quaternary text-capitalize font-weight-bold text-5 m-0 mb-3">Other Upcoming Events</h3>
                                        <div class="pb-2 mb-1">
                                            <?php
                                            $query=mysqli_query($con,"select * from tblevents order by PostingDate DESC limit 10 ");
                                            while ($row=mysqli_fetch_array($query)) {

                                            ?>

                                            <a href="events-details.php?nid=<?php echo htmlentities($row['id'])?>" class="text-color-default text-uppercase text-1 mb-0 d-block text-decoration-none border-top">
