...
$query=mysqli_query($con,"update tblphotos set PostImage='$imgnewfile' where id='$postid'");
if($query)
{
$msg="Image updated ";
}
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Newsportal | Change photos</title>
...
<?php
$postid=intval($_GET['pid']);
$query=mysqli_query($con,"select PostTitle,PostImage from tblphotos where id='$postid' and Is_Active=1 ");
