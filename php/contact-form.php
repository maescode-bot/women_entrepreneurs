...
$email = 'info@wentrepreneursnetworks.org/';
...
try {
	...
	$mail->Host = 'webmail.wentrepreneursnetworks.org';				       // Specify main and backup server
	$mail->SMTPAuth = true;                                  // Enable SMTP authentication
	$mail->Username = 'info@wentrepreneursnetworks.org';                    // SMTP username
	$mail->Password = 'wentrepreneursnetworks01#';                              // SMTP password
